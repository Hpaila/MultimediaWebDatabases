...
if __name__ == '__main__':
    ...
    while True:
        ...
        print("query gestures values ", query_gesture_values)
        task3.call_task3(args.vector_model, args.output_dir, args.user_option, 4, "svd", None)
